...
pub fn generate_rule(rules_enum_ident: Ident, name: &'static str, pattern: Tokens) -> Tokens {
	...
	quote!{
        ...
        fn #ident(state: ::pest::ParserState<#rules_enum_ident>) -> ::pest::ParseResult<::pest::ParserState<#rules_enum_ident>> {
            #pattern
        }
	}
}
...
pub fn generate_public_rule(rules_enum_ident: Ident, name: &'static str, pattern: Tokens) -> Tokens {
	...
	quote!{
		#[inline]
        #[allow(dead_code, non_snake_case, unused_variables)]
        pub fn #ident(state: ::pest::ParserState<#rules_enum_ident>) -> ::pest::ParseResult<::pest::ParserState<#rules_enum_ident>> {
            #pattern
        }
	}
}
